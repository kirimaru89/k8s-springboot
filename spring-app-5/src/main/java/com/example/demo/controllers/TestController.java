...
public class TestController {
    ...
    @Timed(value = "spring-app-5.test.call-async-flow-to-spring-app-2", description = "Time spent in service call")
    ...
    @Timed(value = "spring-app-5.test.test-circuit-breaker", description = "Time spent in service call")
